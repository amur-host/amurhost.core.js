...
(function() {
    ...
    angular.module('amur.core', [
        'amur.core.services',
        'amur.core.constants',
        'amur.core.filter',
        'amur.core.directives'
    ]);
})();
...
(function () {
    'use strict';
    angular.module('amur.core.directives', []);
})();

(function() {
    'use strict';

    angular.module('amur.core.services', ['amur.core', 'restangular'])
        .config(function () {
...
(function () {
    'use strict';
    angular.module('amur.core.filter', []);
})();
...
(function() {
    ...
    angular
        ...
        .service('cryptoService', ['constants.network', '$window', function(constants, window) {
            ...
            // function can be used for sharedKey preparation, as recommended in: https://github.com/amur-host/curve25519-js
...
(function() {
    ...
    angular
        ...
        .service('html5StorageService', ['constants.network', '$window', '$q', function(constants, window, $q) {
            ...
            var $key = 'Amur' + constants.NETWORK_NAME;
...
(function () {
    ...
    angular
        ...
        .service('coinomatCurrencyMappingService', [function () {
            ...
            /**
             * Currency codes for Amur Platform
...
(function () {
    ...
    function CoinomatService(rest, mappingService) {
        ...
        this.getDepositDetails = function (sourceCurrency, targetCurrency, amurRecipientAddress) {
            ...
            return loadPaymentDetails(gatewayCurrencyCode, platformCurrencyCode, amurRecipientAddress);
        };
...
(function () {
    ...
    var AMUR_ASSET_ID = 'AMUR',
        AMUR_PRECISION = 8;

    function denormalizeId(id) {
        return id === AMUR_ASSET_ID ? '' : id;
    }

    function normalizeId(id) {
        return id ? id : AMUR_ASSET_ID;
    }
                ...
                _.forEach(response.markets, function (market) {
                    ...
                    var pair = {
                        ...
                        amountAsset: Currency.create({
                            ...
                            precision: market.amountAssetInfo ? market.amountAssetInfo.decimals : AMUR_PRECISION
                        }),
                        ...
                        priceAsset: Currency.create({
                            ...
                            precision: market.priceAssetInfo ? market.priceAssetInfo.decimals : AMUR_PRECISION
                        }),
    ...
    angular
        ...
        .service('validateService', function () {
            ...
            self.validateAssetIssue = function (issue) {
                ...
                if (issue.fee.currency !== Currency.AMUR) {
                    throw new Error('Transaction fee must be nominated in Amur');
                }
            };
            ...
            self.validateAssetReissue = function (reissue) {
                if (reissue.totalTokens.currency === Currency.AMUR) {
                    throw new Error('Reissuing Amur is not allowed.');
                }
                ...
                if (reissue.fee.currency !== Currency.AMUR) {
                    throw new Error('Transaction fee must be nominated in Amur');
                }
            };
        });
